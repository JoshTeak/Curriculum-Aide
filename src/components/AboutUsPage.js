				...
				<div className="page-body">
					<div className="content-container content-container--major">
						<div className="content-array-column">
							...
							<div className="content-box even-content-box">
								<div className="content-image-box">
